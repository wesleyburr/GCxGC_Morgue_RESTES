...
```{r}
remove_specifics <- c(loc2, loc3, loc4, loc5, loc6)
...
## Merge Compounds, no Stereochemistry Removal
...
write.csv(file = "./REST_top_compounds2.csv", output_df,
          row.names = FALSE)
```
...
write.csv(file = "./REST_top_compounds_withSpecifics2.csv", output_df2,
          row.names = FALSE)
```
...
## Morgue Data, Ready to Rock & Roll
...
write.csv(file = "./Morgue_top_compounds2.csv", output_df,
          row.names = FALSE)
```
...
write.csv(file = "./Morgue_top_compounds_withSpecifics2.csv", output_df2,
          row.names = FALSE)
```
